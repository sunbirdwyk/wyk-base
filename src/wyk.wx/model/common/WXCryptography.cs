...
namespace wyk.wx
{
    public class WXCryptography
    {
        ...
        /// <param name="aes_key">加密串</param>
        /// <param name="corpid"></param>
        /// <returns></returns>
        /// 
        public static string AES_decrypt(string input, string aes_key, ref string corpid)
        {
            byte[] Key;
            Key = Convert.FromBase64String(aes_key + "=");
            byte[] Iv = new byte[16];
        ...
        public static string AES_encrypt(string input, string aes_key, string corpid)
        {
            byte[] Key;
            Key = Convert.FromBase64String(aes_key + "=");
            byte[] Iv = new byte[16];
