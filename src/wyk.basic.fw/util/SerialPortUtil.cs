...
namespace wyk.basic
{
    ...
    public class SerialPortUtil
    {
        ...
        /// <summary>
        /// 通过比较端口名称、波特率、校验位、数据位、停止位来简单判断两个COM是否属性相同
        /// </summary>
        public static bool equal(SerialPort com1, SerialPort com2)
        {
            if (com1 == null || com2 == null)
                return false;

            return com1.PortName.Equals(com2.PortName, StringComparison.OrdinalIgnoreCase)
                && com1.BaudRate == com2.BaudRate
                && com1.Parity == com2.Parity
                && com1.DataBits == com2.DataBits
